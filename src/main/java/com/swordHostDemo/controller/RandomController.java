...
public class RandomController {
    ...
    private AbstractButton ABCcheckBox;
    private AbstractButton abcckBox;
    private AbstractButton NumcheckBox;
    private AbstractButton SigncheckBox;
    ...
    //随机生成密码
    public static String RandomComplexPassword(String str,int StrValue) {
        // 设置密码长度
        int passwordLength = StrValue;

        // Set the characters that can be used in the password
        String passwordCharacters = str;

        // Create a new SecureRandom object
        SecureRandom random = new SecureRandom();

        // Create a new char array to hold the password
